...
const features = [
  { icon: Brain, title: 'AI Face Recognition', desc: 'Advanced computer vision matches missing persons with found individuals.', color: 'bg-blue-100 text-blue-600' },
  ...
  { icon: Bell, title: 'Real-time Notifications', desc: 'Instant alerts for matches and updates.', color: 'bg-purple-100 text-purple-600' },
...
console.log('Written HomePage.tsx');
console.log('div opens:', opens, 'closes:', closes, opens === closes ? 'BALANCED' : 'NOT BALANCED');
